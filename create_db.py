...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'hkalahas', 'email': 'hkalahas@terpmail.umd.edu','first_name':'Haarika', 'last_name':'Kalahasti',
            'password': generate_password_hash('hkalahas', method='pbkdf2:sha256'), 'role':'STUDENT'}
            ]
